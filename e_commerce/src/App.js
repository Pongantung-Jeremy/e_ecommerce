      ...
      <Container>
        ...
        <Row>
          ...
          <Card style={{ width: '400px' ,top:'20px'}}>
            ...
            {/* Row Image  */}
            <Row>
            <Card.Img variant="top" src="rotan.png" width="" height="350" />
            </Row>
            {/* Row Title */}
            <Row>
            <Card.Body>
                <Card.Title>Rotan Chair</Card.Title>
              </Card.Body>
            </Row> 
            {/* Row Info */}
          ...
          <Card style={{ width: '400px' ,top:'20px'}}>
            ...
            {/* Row Image  */}
            <Row>
            <Card.Img variant="top" src="kayu.png" width="" height="350" />
            </Row>
            {/* Row Title */}
            <Row>
            <Card.Body>
          ...
          <Card style={{ width: '400px' ,top:'20px'}}>
            ...
            {/* Row Image  */}
            <Row>
            <Card.Img variant="top" width="" height="350" src="sofabed.jpg" />
            </Row>
            {/* Row Title */}
            <Row>
            <Card.Body>
                <Card.Title>Sofa Bed</Card.Title>
              </Card.Body>
            </Row> 
            {/* Row Info */}
            <Row className="mt-4 mb-4">
